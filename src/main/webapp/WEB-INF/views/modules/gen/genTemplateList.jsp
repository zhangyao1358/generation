...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${path}/gen/genTemplate/">代码模板列表</a></li>
		<li><a href="${path}/gen/genTemplate/form">代码模板添加</a></li>
	</ul>
	<form:form id="searchForm" modelAttribute="genTemplate" action="${path}/gen/genTemplate/" method="post" class="breadcrumb form-search">
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="genTemplate">
			<tr>
				<td><a href="${path}/gen/genTemplate/form?id=${genTemplate.id}">${genTemplate.name}</a></td>
				...
				<shiro:hasPermission name="gen:genTemplate:edit"><td>
    				<a href="${path}/gen/genTemplate/form?id=${genTemplate.id}">修改</a>
					<a href="${path}/gen/genTemplate/delete?id=${genTemplate.id}" onclick="return confirmx('确认要删除该代码模板吗？', this.href)">删除</a>
