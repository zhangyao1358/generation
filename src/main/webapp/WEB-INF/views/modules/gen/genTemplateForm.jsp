...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${path}/gen/genTemplate/">代码模板列表</a></li>
		<li class="active"><a href="${path}/gen/genTemplate/form?id=${genTemplate.id}">代码模板${not empty genTemplate.id?'修改':'添加'}查看</a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="genTemplate" action="${path}/gen/genTemplate/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
