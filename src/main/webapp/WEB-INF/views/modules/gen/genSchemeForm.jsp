...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${path}/gen/genScheme/form?id=${genScheme.id}">生成方案${not empty genScheme.id?'修改':'添加'}查看</a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="genScheme" action="${path}/gen/genScheme/save" method="post" class="form-horizontal">
